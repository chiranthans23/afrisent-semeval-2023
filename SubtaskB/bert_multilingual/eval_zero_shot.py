...
def eval(test_data):
    ...
    model.cuda()
    model.load_state_dict(torch.load( f"/home/admin/data/afrisent-semeval-2023/SubtaskB/bert_multilingual/models/bert-base-multilingual-uncased_all-twi_epoch5.pth"))
    model.eval()
    ...
    print(f'F1 score mBert on zero-shot twi: {val_metrics[2]}')
